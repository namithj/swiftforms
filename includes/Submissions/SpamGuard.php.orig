...
final class SpamGuard {
	...
	/**
	 * Verifies a Cloudflare Turnstile response server-side. Passes (returns
	 * true) when Turnstile is enabled on the form but no secret key is
	 * configured yet, since that's a site-setup gap, not a spam signal.
	 */
