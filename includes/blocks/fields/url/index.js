...
registerBlockType( 'swiftforms/url-field', {
    edit( { attributes, setAttributes, clientId } ) {
        ...
        return (
            <div { ...blockProps }>
                <InspectorControls>
                    <PanelBody title={ __( 'URL Field Settings', 'swiftforms' ) } initialOpen={ true }>
                ...
                <RichText tagName="span" className="swiftforms-field__label" value={ label } onChange={ onLabelChange } placeholder={ __( 'URL label', 'swiftforms' ) } />
