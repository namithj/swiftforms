...
registerBlockType( 'swiftforms/file-field', {
    edit( { attributes, setAttributes, clientId } ) {
        ...
        return (
            <div { ...blockProps }>
                <InspectorControls>
                    <PanelBody title={ __( 'File Field Settings', 'swiftforms' ) } initialOpen={ true }>
                ...
                <RichText tagName="span" className="swiftforms-field__label" value={ label } onChange={ onLabelChange } placeholder={ __( 'File label', 'swiftforms' ) } />
