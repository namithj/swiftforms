...
registerBlockType( 'swiftforms/textarea-field', {
    edit( { attributes, setAttributes } ) {
        ...
        return (
            <div { ...blockProps }>
                <InspectorControls>
                    <PanelBody title="Textarea Settings" initialOpen={ true }>
                ...
                <RichText tagName="span" className="swiftforms-field__label" value={ label } onChange={ ( value ) => setAttributes( { label: value } ) } placeholder="Textarea label" />
                <textarea disabled placeholder={ placeholder || 'Tell us more...' } rows="4"></textarea>
