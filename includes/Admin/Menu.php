 ...
 * WordPress core (`_add_post_type_submenus()`) since the `smartlogix_swf_entry` CPT
...
final class Menu implements Registrable {
	...
	public function register_menu(): void {
		...
		add_menu_page(
			...
			__( 'SwiftForms', 'swiftforms' ),
			'edit_smartlogix_swf_forms', // phpcs:ignore WordPress.WP.Capabilities.Unknown -- registered for administrators in Activation.
			$form_edit_slug,
			'',
			'dashicons-feedback',
			30
